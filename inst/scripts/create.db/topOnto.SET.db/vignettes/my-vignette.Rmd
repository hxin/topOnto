---
title: "topOnto.HDO.db"
author: "Xin He"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{topOnto.HDO.db}
  %\VignetteEngine{knitr::rmarkdown}
  \usepackage[utf8]{inputenc}
---

# Overview
This vignette demonstrates how to easily use the topOnto.HDO.db package. The topOnto.HDO.db package is use to represent an ontology. Terms in ontology are organized in Directed Acyclic Graph (DAG) that represent the content through Bimap object.
...
# Fetch terms
In topOnto.HDO.db, ONTTermsAnnDbBimap object(a sub-class of Bimap) ONTTERM represet the whole terms. Meanwhile a class named ONTTerms represents with six slots. Six S4 methods
ID,Definition,Ontology,Term,Synonym,Secondary are defned in topOnto.HDO.db to fetch the corresponding attribute for a term node, they can work on ONTTermsAnnDbBimap, ONTTerms and character classes.
...
the maps in topOnto.HDO.db. To get the schema, type following:
```{r}
ONT_dbschema()
```
